...
class Cell(object):
    ...
    def __init__(self, x, y, px, py, tile):
        ...
        self.rect = Rect((self.left, self.top), (tile.tile_width, tile.tile_height))
...
class SpriteLayer(pygame.sprite.OrderedUpdates):
