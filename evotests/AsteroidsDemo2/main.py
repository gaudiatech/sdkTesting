...
class ShipModel(CogObject):
    ...
    def three_pt_repr(self):
        ...
        temp[0].multiply(self.WSHIP_RATIO * self.RAD)
        temp[1].multiply(self.LENSHIP_RATIO * self.RAD)  # pointe
        temp[2].multiply(self.WSHIP_RATIO * self.RAD)
...
class TinyWorldView(EventReceiver):
    ...
    def proc_event(self, ev, source):
        if ev.type == EngineEvTypes.PAINT:
            ...
            pygame.draw.polygon(ev.screen, FG_COLOR, self.ship.three_pt_repr())
